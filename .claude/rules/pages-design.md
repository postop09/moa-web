...
import { CsDiagnosticBand } from './ui/CsDiagnosticBand';
import { MonthlyDiagnosticPanel } from './ui/MonthlyDiagnosticPanel';
...
3. `index.tsx`에서 섹션을 조립하고 `{Domain}Page`를 export.
